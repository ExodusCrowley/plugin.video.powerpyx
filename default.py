...
channellist=[
		...
		("[B]Days Gone Trophy Guide[/B]", "playlist/gnfc2zLnbU0&list=PLRr5L69yg_kErFWk0M_UV7tHmtKhCFO2o", ''),
		("[B]Mortal Kombat 11[/B]", "playlist/A-_k9PE0OKM&list=PLRr5L69yg_kGzu80y6_iYHAcfbx9-sh6y", ''),
		("[B]Sekiro Shadows Die Twice Trophy Guide[/B]", "playlist/PLRr5L69yg_kEJkMWG-EroGgsRs6Xtt5kM", ''),
		("[B]Sekiro Shadows Die Twice All Boss Fights / All Bosses[/B]", "playlist/PLRr5L69yg_kFInSVvVxJX4SJlb78s2mZ-", ''),
